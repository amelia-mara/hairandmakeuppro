...
function addModalStyles() {
    ...
    style.textContent = `
        ...
        .confirm-close:hover { color: var(--accent-gold); }
        ...
        .confirm-merge-item:hover { background: rgba(212, 175, 122, 0.06); }
        ...
        .confirm-merge-info { flex: 1; min-width: 0; }
        ...
        .confirm-selection-info { flex: 1; min-width: 0; }
