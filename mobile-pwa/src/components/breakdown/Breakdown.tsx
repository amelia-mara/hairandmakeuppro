        ...
        <div className="px-4 py-3">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={handleExportCSV} className="text-xs text-gold font-medium px-2 py-1 rounded-md border border-gold/40">
                Export CSV
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative flex-1">
              <select
                ...
                className="w-full pl-2.5 pr-7 py-1.5 bg-muted rounded-lg text-xs text-foreground border-none outline-none focus:ring-1 focus:ring-gold/50 appearance-none"
              >
