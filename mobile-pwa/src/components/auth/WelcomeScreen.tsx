    ...
    <div className="min-h-screen flex flex-col" style={{
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        ...
        <div className="relative mb-8" style={{ width: '280px', height: '100px' }}>
          <span className="absolute left-[10px] top-0 text-[50px] leading-none font-serif font-bold text-[#2A1A08]">
            Checks
          </span>
          <span className="absolute right-[10px] top-[38px] text-[50px] leading-none font-serif font-bold italic text-gold" style={{ transform: 'rotate(-3deg)' }}>
            Happy.
          </span>
        </div>
